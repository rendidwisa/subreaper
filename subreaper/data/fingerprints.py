...
TAKEOVER_FINGERPRINTS = [
    ...
    },
    {
        ...
        "response_fingerprints": [
            _fp("render.com/404", STRENGTH_STRONG, SIGNAL_ORPHAN),
            _fp("site not found — render", STRENGTH_STRONG, SIGNAL_ORPHAN),
        ],
        "http_codes": [404],
        "confidence": "HIGH",
        "claimable": True,
    ...
    },
    {
        ...
        "response_fingerprints": [
            _fp("Help Center Closed", STRENGTH_STRONG, SIGNAL_ORPHAN),
            _fp("this account is not active", STRENGTH_STRONG, SIGNAL_ORPHAN),
            _fp("zendesk.com/hc", STRENGTH_MEDIUM, SIGNAL_ORPHAN), 
        ],
        "http_codes": [404],           
        "confidence": "HIGH",
        "claimable": True,
    ...
    },
    {
        ...
        "response_fingerprints": [
            _fp("Your client does not have permission to get URL", STRENGTH_STRONG, SIGNAL_ORPHAN),
            _fp("run.app", STRENGTH_MEDIUM, SIGNAL_ORPHAN),
        ],
        "http_codes": [404],
        "confidence": "MEDIUM",
        "claimable": False,
    ...
    # ── Cloud (Other) ────────────────────────────────────────────────────
    {
        ...
        "response_fingerprints": [
            _fp("404 from fly proxy", STRENGTH_STRONG, SIGNAL_ORPHAN),
            _fp("fly-request-id", STRENGTH_MEDIUM, SIGNAL_ORPHAN),
        ],
        "http_codes": [404],
        "confidence": "MEDIUM",
        "claimable": False,
